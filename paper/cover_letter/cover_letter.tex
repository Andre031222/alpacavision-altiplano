...
\begin{flushright}
  Richar Andre Vilca-Solorzano (Submitting \& Corresponding Author)\\
...
\begin{enumerate}
  ...
  \item \textbf{Honest feasibility study (negative result):} under a leakage-free
        ...
        (AUC-ROC = 0.506, 95\% CI [0.366, 0.645]). Because the identical pipeline
...
Richar Andre Vilca-Solorzano (Submitting \& Corresponding Author)\\[4pt]
